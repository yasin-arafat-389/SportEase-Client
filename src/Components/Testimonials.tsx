          ...
          <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
            <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 bg-gray-300">
              <p className="relative px-6 py-1 text-lg italic text-center dark:text-gray-800">
                ...
                Booking a football field has never been easier! The platform is
                super intuitive, and I always find a great spot for my team’s
                matches. The facilities are top-notch, and the experience is
                always seamless.
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
          ...
          <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
            <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 bg-gray-300">
              <p className="relative px-6 py-1 text-lg italic text-center dark:text-gray-800">
                ...
                football, tennis, or hockey, I can easily find and book amazing
                facilities near me. The entire process is smooth and
                hassle-free.
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
            ...
            <div className="bg-button flex flex-col items-center justify-center p-8 rounded-b-lg dark:bg-violet-600 dark:text-gray-50">
              ...
              <p className="text-sm uppercase">
                Manager, Bangladesh Sports Comittee
              </p>
            </div>
          </div>
        </div>
